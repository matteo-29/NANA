...
const de: Dict = {
  ...
  "bus.arrival": "ANKUNFT",
  "bus.departurePlace": "29.03.2027, Bahnhof Hiroshima, Shinkansen-Ausgang",
  ...
  "hotel.vatNote": "Der Preis versteht sich inkl. 10% Mehrwertsteuer. Die Zahlung erfolgt individuell direkt beim Check-out im Hotel.",
...
const en: Dict = {
  ...
  "bus.arrival": "ARRIVAL",
  "bus.departurePlace": "29 MAR 2027, Hiroshima Station, Shinkansen Exit",
  "bus.arrivalPlace": "Grand Prince Hotel Hiroshima",
  ...
  "hotel.vatNote": "Prices include 10% VAT. Payment is made individually at hotel check-out.",
...
const ja: Dict = {
  ...
  "bus.departure": "出発",
  "bus.arrival": "到着",
  "bus.departurePlace": "2027年3月29日 広島駅 新幹線口",
  ...
  "hotel.vatNote": "価格には消費税10%が含まれており、お支払いはホテルチェックアウト時に各自で行っていただきます。",
